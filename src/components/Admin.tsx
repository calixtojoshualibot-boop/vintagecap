...
const COND_STYLES: Record<string,string> = {
  good:'bg-emerald-500', 'renovated condition':'bg-green-500',
};
...
export default function Admin({ onBack }: Props) {
        ...
        <div className="bg-white border-b border-slate-200 sticky top-0 z-40">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <NBALogo size={32}/>
              <h1 className="font-black text-lg uppercase tracking-wide">Admin Dashboard</h1>
            </div>
            <div className="flex items-center gap-3">
              ...
              <button onClick={onBack} className="flex items-center gap-2 px-3 py-2 rounded-lg text-slate-500 hover:bg-slate-100 text-sm font-semibold">
                <LogOut size={14}/> Back to Showcase
              </button>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white border-b border-slate-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center gap-3">
          <button onClick={()=>{setTab('list');resetForm();}} className="p-2 rounded-lg hover:bg-slate-100 text-slate-500"><ArrowLeft size={18}/></button>
